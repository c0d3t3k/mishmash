    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-background flex min-h-svh w-full data-[state=collapsed]:w-0",
            className
          )}
          {...props}
        >
...
function Sidebar({
  ...
  return (
    <div
      className={cn(
        "group h-full peer text-sidebar-foreground hidden md:block transition-all duration-200 ease-linear",
